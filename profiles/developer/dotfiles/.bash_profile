...
# ships its own so ~/.bashrc loads the same way regardless of what the
# OS default did or didn't set up - see `default`'s copy of this file
# for the bug this fixes (a minimal Fedora VM, 2026-09-12).
